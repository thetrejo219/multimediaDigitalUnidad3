...
export default function Page() {
  ...
  // En este ejemplo mostramos todos los nuevos videojuegos (puedes aplicar filtros si lo requieres)
  const filteredGames = nuevosVideojuegos;
  ...
  return (
    <>
      ...
      <div className="relative">
        ...
        {/* Listado de productos con indicador de oferta */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
          {filteredGames.map((articulo) => (
            ...
            >
              {/* Badge para indicar "Oferta" si el videojuego está en oferta */}
              {articulo.oferta && (
